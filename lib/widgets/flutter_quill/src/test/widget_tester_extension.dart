...
extension QuillEnterText on WidgetTester {
  ...
  Future<void> quillGiveFocus(Finder finder) {
    return TestAsyncUtils.guard(() async {
      final editor = state<AnonQuillEditorState>(
        find.descendant(
            of: finder,
            matching:
                find.byType(AnonQuillEditor, skipOffstage: finder.skipOffstage),
            matchRoot: true),
      );
  ...
  /// keyboard.
  ///
  /// The widget specified by [finder] must be a [AnonQuillEditor] or have a
  /// [AnonQuillEditor] descendant. For example `find.byType(QuillEditor)`.
  ...
  /// [AnonQuillEditor] or have a [AnonQuillEditor] descendant. For example
