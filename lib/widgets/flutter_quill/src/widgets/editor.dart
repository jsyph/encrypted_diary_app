...
/// Modification of QuillEditor , but `enableIMEPersonalizedLearning` is set to false
class AnonQuillEditor extends StatefulWidget {
  const AnonQuillEditor({
  ...
  @override
  AnonQuillEditorState createState() => AnonQuillEditorState();
}

class AnonQuillEditorState extends State<AnonQuillEditor>
...
class _QuillEditorSelectionGestureDetectorBuilder
  ...
  final AnonQuillEditorState _state;
